...
//     version 1.11.2
//     from Assets/Game/Inputs/PlayerControlMap.inputactions
//
...
public partial class @PlayerControlMap: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerControlMap()
    {
        UnityEngine.Debug.Assert(!m_PlayerControl.enabled, "This will cause a leak and performance issues, PlayerControlMap.PlayerControl.Disable() has not been called.");
    }
